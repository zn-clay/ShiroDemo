...
<tr>
	<td>商品生产日期</td>
	<td><input type="text" name="createtime" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH-mm-ss',readOnly:true})" value="<fmt:formatDate value="${items.createtime}" pattern="yyyy-MM-dd HH-mm-ss"/>"/></td>
</tr>
<tr>
	<td>商品图片</td>
	<td>
